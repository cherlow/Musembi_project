      ...
      <div class="row">
                  ...
                  <div class="submit-field">
                    <h5>
                      ...
                      <i
                        class="help-icon"
                        data-tippy-placement="right"
                        title="Up to 5 skills that best describe your Job"
                      ></i>
                    </h5>
        ...
        <div class="col-xl-12">
          <a
            ...
            @click="submitform()"
            ><i class="icon-feather-plus"></i> Post a Job</a
          >
        </div>
      </div>
      <!-- Row / End -->
...
export default {
  ...
  methods: {
    ...
    submitform() {
      ...
      formData.append("min_budget", 0);
      formData.append("max_budget", 0);
      formData.append("skills", skillarray);
      formData.append("mode", 0);
      formData.append("description", this.description);

      axios
        .post("/api/newtask", formData, {
          headers: {
    ...
    uploadtaskattachments() {
      ...
      for (let i = 0; i < attachments.files.length; i++) {
        ...
        axios
          .post("/api/uploadtaskattachments", formData, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
